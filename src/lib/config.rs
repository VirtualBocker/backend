...
impl Config {
    pub fn from_env() -> Self {
        Self {
            date_format: match env::var("DATE_FORMAT").unwrap_or_default().as_str() {
            ...
            time_format: match env::var("TIME_FORMAT").unwrap_or_default().as_str() {
            ...
            log_level: match env::var("LOG_LEVEL").unwrap_or_default().as_str() {
    ...
    pub fn with_time_format(mut self, time_format: config_enums::TimeFormat) -> Self {
        self.time_format = time_format;
        self
    }

    pub fn with_date_format(mut self, date_format: config_enums::DateFormat) -> Self {
        self.date_format = date_format;
        self
    }

    pub fn with_log_level(mut self, log_level: config_enums::LogLevel) -> Self {
